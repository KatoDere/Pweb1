...
insert into cusuario (nombre,apPaterno,apMaterno,login,password)
values ('Gustavo','Guajardo','Lopez','gustavog','33c7e778c824bf6d727204ac40d909f6');  /*gguajardo*/

insert into cusuario (nombre,apPaterno,apMaterno,login,password)
values ('Bernardo','Atilano','Gomez','bernardoa','d1a390f21bd30c3ea1e6311a19270dcf');  /*batilano*/

insert into cusuario (nombre,apPaterno,apMaterno,login,password)
values('Adalberto','Pineda','Zapata','adalbertop','78ba07091135afa4cf2559d772c89de8');  /*apineda*/

insert into cusuario (nombre,apPaterno,apMaterno,login,password)
values('Feliciano','Gomez', 'Landaverde','felicianog','f6c5faa9645a3b0e864a052301c9cf20'); /*fgomez*/

insert into cusuario (nombre,apPaterno,apMaterno,login,password)
values('Felipe','Calderon','Hinojsa','felipec','95513ae1e16dbd624ff6008076becd71');
